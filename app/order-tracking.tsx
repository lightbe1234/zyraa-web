...
export function OrderTracking({ catalog }: { catalog: Product[] }) {
  ...
  return <main className="logistics-page">
    ...
    <section className="logistics-partners"><div><p className="eyebrow">Our delivery partners</p><h2>Across Pakistan.</h2><p>Courier selection depends on your address and service availability.</p></div><CourierLogos /></section>
