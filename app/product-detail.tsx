    ...
    <div className="pdp-layout">
      ...
      <section className="pdp-info" aria-label="Product and purchase options">
        ...
        <div className="pdp-assurances">
          ...
          <a href="/pages/returns"><PackageCheck aria-hidden="true" /><p><strong>14-day size exchange</strong><span>Unworn items · see exchange conditions</span></p><ArrowRight aria-hidden="true" /></a>
        </div>
        <div className="pdp-accordions">
          ...
          <details><summary>Delivery & exchange<ChevronDown /></summary><div><p>{settings.flatShipping ? `Standard delivery is ${money(settings.flatShipping)}.` : 'Standard delivery is free.'} {settings.freeShippingThreshold > 0 ? `Orders of ${money(settings.freeShippingThreshold)} or more qualify for free shipping.` : ''} Delivery details and the final total are shown at checkout.</p><p>Size exchanges can be requested within 14 days for unworn items, subject to availability and the store’s exchange conditions.</p><a href="/pages/shipping">Delivery information</a><a href="/pages/returns">Exchange policy</a></div></details>
        </div>
