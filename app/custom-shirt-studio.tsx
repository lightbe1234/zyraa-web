...
export function CustomShirtBanner() {
  ...
  return <a className="zs-banner" href="/customise-your-shirt">
    ...
    <div className="zs-banner-copy"><span>ZYRA / CUSTOM SHIRTS</span><h2>Your design.<br/>On your shirt.</h2><p>Choose the colour. Send us your artwork.</p><span className="zs-banner-link">Customise your shirt <ArrowUpRight size={22}/></span></div>
    <span className="zs-banner-corner" aria-hidden="true">MADE FOR YOU / 01</span>
  </a>;
}
